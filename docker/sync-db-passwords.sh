...
R "ALTER ROLE service_role WITH BYPASSRLS;" >/dev/null 2>&1
R "ALTER ROLE supabase_admin WITH BYPASSRLS;" >/dev/null 2>&1
R "ALTER ROLE supabase_storage_admin WITH BYPASSRLS;" >/dev/null 2>&1
